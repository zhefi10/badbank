...
function CreateAccount() {
    ...
    return (
        <Card 
            ...
            text={show ? <>Register here to start hating the benefits of BadBank</>:<>Click <span className="badge bg-success">Add another account?</span> <br/> or <br/> <span className="badge bg-success">Login</span> to access to your account</>}
            body={
